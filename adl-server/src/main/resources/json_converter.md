...
5. If the schema asks for a question, but the input text does not contain a question use `null`.
6. Do not include any explanations, markdown formatting (like ```json ... ```), or conversational text in the output. Just return the raw JSON string.
