...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1312: (x0,x1) => x0.createMediaStreamSource(x1),
      _1313: (x0,x1) => x0.addModule(x1),
      _1314: x0 => ({parameterData: x0}),
      _1315: (x0,x1,x2) => new AudioWorkletNode(x0,x1,x2),
      ...
      _1465: x0 => x0.abort(),
      _1466: () => new AbortController(),
      _1467: x0 => x0.getReader(),
      _1468: x0 => x0.read(),
      _1469: x0 => x0.cancel(),
      _1471: () => new XMLHttpRequest(),
      _1472: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1473: x0 => x0.send(),
      _1475: () => new FileReader(),
      _1476: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1477: (x0,x1) => x0.item(x1),
      _1478: (x0,x1) => x0.removeChild(x1),
      ...
      _1572: (d, precision) => d.toPrecision(precision),
      _1573: () => globalThis.document,
      _1593: x0 => x0.src,
      _1594: (x0,x1) => x0.src = x1,
      _1595: x0 => x0.naturalWidth,
      _1596: x0 => x0.naturalHeight,
      _1612: x0 => x0.status,
      _1613: (x0,x1) => x0.responseType = x1,
      _1615: x0 => x0.response,
      _1664: (x0,x1) => x0.responseType = x1,
      _1665: x0 => x0.response,
      _2100: (x0,x1) => x0.download = x1,
      _2125: (x0,x1) => x0.href = x1,
      _2344: x0 => x0.error,
      _2346: (x0,x1) => x0.src = x1,
      _2351: (x0,x1) => x0.crossOrigin = x1,
      _2354: (x0,x1) => x0.preload = x1,
      _2358: x0 => x0.currentTime,
      _2359: (x0,x1) => x0.currentTime = x1,
      _2360: x0 => x0.duration,
      _2365: (x0,x1) => x0.playbackRate = x1,
      _2374: (x0,x1) => x0.loop = x1,
      _2378: (x0,x1) => x0.volume = x1,
      _2395: x0 => x0.code,
      _2396: x0 => x0.message,
      _2667: (x0,x1) => x0.accept = x1,
      _2681: x0 => x0.files,
      _2707: (x0,x1) => x0.multiple = x1,
      _2725: (x0,x1) => x0.type = x1,
      _3444: () => globalThis.window,
      _3506: x0 => x0.navigator,
      _3770: x0 => x0.localStorage,
      _3829: x0 => x0.message,
      _3879: x0 => x0.mediaDevices,
      _3895: x0 => x0.userAgent,
      _3896: x0 => x0.vendor,
      _3946: x0 => x0.data,
      _3983: (x0,x1) => x0.onmessage = x1,
      _4103: x0 => x0.length,
      _4320: x0 => x0.readyState,
      _4329: x0 => x0.protocol,
      _4333: (x0,x1) => x0.binaryType = x1,
      _4336: x0 => x0.code,
      _4337: x0 => x0.reason,
      _5487: x0 => x0.destination,
      _5491: x0 => x0.state,
      _5492: x0 => x0.audioWorklet,
      _5855: x0 => x0.port,
      _5994: x0 => x0.type,
      _6035: x0 => x0.signal,
      _6047: x0 => x0.length,
      ...
      _6188: x0 => x0.body,
      _6521: (x0,x1) => x0.id = x1,
      _6548: x0 => x0.children,
      _7867: x0 => x0.value,
      _7869: x0 => x0.done,
      _8049: x0 => x0.size,
      _8057: x0 => x0.name,
      _8058: x0 => x0.lastModified,
      _8063: x0 => x0.length,
      _8069: x0 => x0.result,
      _8560: x0 => x0.url,
      _8562: x0 => x0.status,
...
"agentUrlNotifierProvider",
"http://localhost:8080",
"queryParameters",
"envs",
"StringList",
"http://localhost:8090",
"envsRepositoryProvider",
"envNotifierProvider",
"activated: ",
"names: ",
"noCache",
...
"Missing fragment ",
"Unknown selection node type",
"skip",
"if",
"include",
"DanglingReferenceException(path: ",
"Node",
"PartialDataException(path: ",
"$ref",
"_id",
"query",
"mutation",
...
"KA==",
"KQ==",
"Should never read while validating",
"accept",
...
"Unknown type system extension type '",
...
"braceR",
"Expected an input value name",
"colon",
"Expected ':' followed by input value type",
"equals",
"bracketL",
"int",
"float",
...
"!",
"at",
"Expected directive name starting with '@'",
...
"Unknown operation '",
"Expected keyword '",
"Unknown type system definition type '",
...
"DirectiveLocation.",
"Expected a directive location",
"Unknown directive location '",
"Expected a operation type definitions starting with '{'",
"Unknown executable definition '",
"fragment ",
"Expected a selection set starting with '{'",
"spread",
"Expected a field or field alias name",
"Expected '...' spread before fragment",
"on ",
...
"There was an error causing connection lost: ",
...
"[SocketClient] message stream encountered error: ",
"stacktrace:\n",
...
"LA==",
"ContextWriteException(originalException: ",
", originalStackTrace: ",
"ServerException(originalException: ",
", parsedResponse: ",
"ResponseFormatException(originalException: ",
"Invalid status code ",
...
"dart-http-boundary-",
"ContextReadException(originalException: ",
"RequestFormatException(originalException: ",
", request: ",
"name shouldn't start with a '.'",
"name shouldn't end with a '.'",
"INFO",
"name: ",
"agentsNotifierProvider",
"called ProviderSubscription.read on a subscription that was closed",
"agentClientNotifierProvider",
...
"Loading Agents...",
"No Agents found",
"Warning: Safari cannot connect to local Agents.",
"max",
"Connect",
"clip",
"loose",
...
"<.*>",
"Edit Use Case",
"Add new Use Cases. These are stored locally.",
"Overview (",
"Clear Search",
...
"selectedUseCaseGroupNotifierProvider",
"Performance",
"Conversations",
"Import Metrics",
"Agent Metrics",
...
"Plot(x: ",
", y: ",
"eventsToMetricsConverterProvider",
"agentEventsNotifierProvider",
...
"non-empty.",
"metricsImporterProvider",
"Events",
"No events",
"Click here for details",
"Open Help page in a browser",
"Close Filters",
"Filters",
"Clear filters",
"_expansionTileTheme",
...
"Tests",
"At least one Agent must be connected to run Tests.",
...
"audio/pcm",
"STREAM_SOURCE",
"BinaryData(dataAsBase64: ",
", mimeType: ",
", source: ",
"Error: ",
"selectedToolNotifierProvider",
"toolsNotifierProvider",
"testTools",
"TestToolParameter(name: ",
", type: ",
"toolsRepositoryProvider",
"currentPromptNotifierProvider",
"messageSenderProvider",
"Edit Message and replay conversation.",
"Edit Message",
"Update Conversation",
"testcases",
...
", lastRunAt: ",
"testCases.json",
"testCasesExporterProvider",
"testCasesImporterProvider",
"Use Cases",
"Loading Use Cases...",
...
"New UseCases File",
"md",
"useCaseImporterProvider",
"tag: ",
"Clear Filter",
"useCaseGroupsNotifierProvider",
"Personal",
"Local storage",
"UseCaseGroup(id: ",
", primary: ",
...
"Show Schema",
"Test",
"Tools cannot be loaded for this Agent.",
...
"Exports All Tools",
"Add a new tool.",
"toolsExporterProvider",
"Edit Test Tool",
"Add New Test Tool",
"Tool Title (For display only)",
"Tool Name (Example: get_bill)",
"Tool Description",
"Add Parameter",
"Parameter Name",
...
"agentStreamClientNotifierProvider",
"voice message",
"pcm16bits",
"defaultSource",
"defaultToSpeaker",
...
"New Conversation",
"Run Test",
"Add conversation as Test Case",
"Test ",
" added. Goto [Tests](#/tests) to view.",
"Test: ",
"hide",
...
"Group",
"group: ",
" ran successfully. [Tests](#/tests)",
" failed. [Tests](#/tests)",
"Add User Token",
"Adds a user token to the request.",
"_SwitchType.",
"systemGreen",
"secondarySystemFill",
"/settings",
"conversation.json",
"ConversationExport(conversation: ",
", events: ",
"conversationExporterProvider",
"conversationImporterProvider",
" Tools active",
"DeSelect Tools",
"featuresNotifierProvider",
"Feature(name: ",
"connected to",
"localhost",
"Refresh Agents",
...
", examples: ",
"AgentCardRetriever",
"What magic should we create today?",
...
"Exception during token revocation: ",
"OidcDesktopService",
"openid.credential.issuerBaseUrl",
"openid.credential.client_id",
"openid.credential.client_secret",
"openid.credential.redirect_base_url",
"http://localhost:9876",
"openid.credential.call_back_path",
"/callback",
"openid.credential.scopes",
"openid.type",
"Welcome to the Arc View",
"Please sign in with ",
"RA==",
